...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # aoi_contenttype = ContentType.objects.get(name="aoi")
        # collection_contenttype = ContentType.objects.get(name="collection")
        # collections = orm.Collection.objects.all()
        ...
        for aoi in orm.AOI.objects.all():
            ...
            # if aoi.content_type_id == collection_contenttype.id:
            #     for collection in collections:
            #         if collection.pk == aoi.object_id:
            aoi_multi.content_type_id = aoi.content_type_id
            aoi_multi.object_id = aoi.object_id

            # if 'collection' in aoi.keys():
            #     print('collection in aoi.keys')
            #     if not aoi.collection == None:
            #         print('aoi.collect is not None')
            #         aoi_multi.collection = aoi.collection
