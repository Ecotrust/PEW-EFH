...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collection.import_file'
        db.delete_column(u'drawing_collection', 'import_file')


    def backwards(self, orm):
        # Adding field 'Collection.import_file'
        db.add_column(u'drawing_collection', 'import_file',
