...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AOI_Multi'
        db.delete_table(u'drawing_aoi_multi')

        # Removing M2M table for field sharing_groups on 'AOI_Multi'
        db.delete_table(db.shorten_name(u'drawing_aoi_multi_sharing_groups'))


    def backwards(self, orm):
        # Adding model 'AOI_Multi'
        db.create_table(u'drawing_aoi_multi', (
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('manipulators', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'drawing_aoi_multi_related', to=orm['auth.User'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'drawing_aoi_multi_related', null=True, to=orm['contenttypes.ContentType'], blank=True)),
        ...
        db.send_create_signal(u'drawing', ['AOI_Multi'])

        # Adding M2M table for field sharing_groups on 'AOI_Multi'
        m2m_table_name = db.shorten_name(u'drawing_aoi_multi_sharing_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('aoi_multi', models.ForeignKey(orm[u'drawing.aoi_multi'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['aoi_multi_id', 'group_id'])
