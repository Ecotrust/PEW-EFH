...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'drawing_aoi', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'drawing_aoi_related', null=True, to=orm['contenttypes.ContentType'], blank=True)),
