...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GridCell.strata_3x3'
        db.add_column(u'drawing_gridcell', 'strata_3x3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridCell.strata_5x5'
        db.add_column(u'drawing_gridcell', 'strata_5x5',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GridCell.strata_3x3'
        db.delete_column(u'drawing_gridcell', 'strata_3x3')

        # Deleting field 'GridCell.strata_5x5'
        db.delete_column(u'drawing_gridcell', 'strata_5x5')
    ...
    models = {
        ...
        u'drawing.gridcell': {
            ...
            'strata_3x3': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'strata_5x5': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
