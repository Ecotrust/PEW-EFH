...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'drawing_aoi_multi', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'drawing_aoi_multi_related', null=True, to=orm['contenttypes.ContentType'])),
