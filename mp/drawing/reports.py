...
def get_summary_reports(grid_cells, attributes):
    ...
    attributes.append({'title': 'Total Area', 'data': str(format_precision(float(total_area) / 1000000, 2)) + ' sq km'})
