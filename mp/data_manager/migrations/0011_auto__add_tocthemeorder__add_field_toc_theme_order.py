...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TOCThemeOrder'
        db.create_table(u'data_manager_tocthemeorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_manager.Theme'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'data_manager', ['TOCThemeOrder'])

        # Adding field 'TOC.theme_order'
        db.add_column(u'data_manager_toc', 'theme_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_manager.TOCThemeOrder'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TOCThemeOrder'
        db.delete_table(u'data_manager_tocthemeorder')

        # Deleting field 'TOC.theme_order'
        db.delete_column(u'data_manager_toc', 'theme_order_id')
    ...
    models = {
        ...
        u'data_manager.toc': {
            ...
            'theme_order': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_manager.TOCThemeOrder']", 'null': 'True', 'blank': 'True'}),
        ...
        u'data_manager.tocthemeorder': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['data_manager.Theme']"})
        }
    }
