...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field themes on 'TOC'
        db.delete_table(db.shorten_name(u'data_manager_toc_themes'))


    def backwards(self, orm):
        # Adding M2M table for field themes on 'TOC'
        m2m_table_name = db.shorten_name(u'data_manager_toc_themes')
        ...
        db.create_unique(m2m_table_name, ['toc_id', 'toctheme_id'])
