...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for layer in orm.Layer.objects.all():
            if layer.url:
                layer.url_backup = layer.url
                layer.save()

    def backwards(self, orm):
        # "Write your backwards methods here."
        for layer in orm.Layer.objects.all():
            if layer.url_backup and not layer.url == layer.url_backup:
                if len(layer.url_backup) > 254:
                    layer.url = layer.url_backup[:254]
                else:
                    layer.url = layer.url_backup
                layer.save()
    ...
    models = {
        ...
        u'data_manager.layer': {
            ...
            'url_backup': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
