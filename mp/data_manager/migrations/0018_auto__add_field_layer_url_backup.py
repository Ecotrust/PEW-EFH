...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.url_backup'
        db.add_column(u'data_manager_layer', 'url_backup',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.url_backup'
        db.delete_column(u'data_manager_layer', 'url_backup')
