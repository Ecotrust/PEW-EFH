...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TOCThemeOrder.theme'
        db.alter_column(u'data_manager_tocthemeorder', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_manager.TOCTheme']))

    def backwards(self, orm):

        # Changing field 'TOCThemeOrder.theme'
        db.alter_column(u'data_manager_tocthemeorder', 'theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data_manager.Theme']))
