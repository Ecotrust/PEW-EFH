...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImportLayer'
        db.create_table(u'data_manager_importlayer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'data_manager_importlayer_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'data_manager_importlayer_related', null=True, to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'data_manager', ['ImportLayer'])

        # Adding M2M table for field sharing_groups on 'ImportLayer'
        m2m_table_name = db.shorten_name(u'data_manager_importlayer_sharing_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('importlayer', models.ForeignKey(orm[u'data_manager.importlayer'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['importlayer_id', 'group_id'])


    def backwards(self, orm):
        # Deleting model 'ImportLayer'
        db.delete_table(u'data_manager_importlayer')

        # Removing M2M table for field sharing_groups on 'ImportLayer'
        db.delete_table(db.shorten_name(u'data_manager_importlayer_sharing_groups'))
