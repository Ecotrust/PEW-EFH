...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.enable_mapbox_id'
        db.add_column(u'data_manager_layer', 'enable_mapbox_id',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Layer.mapbox_tileset_id'
        db.add_column(u'data_manager_layer', 'mapbox_tileset_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.mapbox_access_token'
        db.add_column(u'data_manager_layer', 'mapbox_access_token',
                      self.gf('django.db.models.fields.CharField')(default='pk.eyJ1IjoiZWZoc3VwcG9ydCIsImEiOiJjam9oamt6YjAwcWgyM3dxaG83MzVwajk2In0.tt6jiyeTJl-GuCXxBEF5wg', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.enable_mapbox_id'
        db.delete_column(u'data_manager_layer', 'enable_mapbox_id')

        # Deleting field 'Layer.mapbox_tileset_id'
        db.delete_column(u'data_manager_layer', 'mapbox_tileset_id')

        # Deleting field 'Layer.mapbox_access_token'
        db.delete_column(u'data_manager_layer', 'mapbox_access_token')
    ...
    models = {
        ...
        u'data_manager.layer': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'enable_mapbox_id': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'mapbox_access_token': ('django.db.models.fields.CharField', [], {'default': "'pk.eyJ1IjoiZWZoc3VwcG9ydCIsImEiOiJjam9oamt6YjAwcWgyM3dxaG83MzVwajk2In0.tt6jiyeTJl-GuCXxBEF5wg'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'mapbox_tileset_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'themes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['data_manager.Theme']", 'null': 'True', 'blank': 'True'}),
            'url': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
