...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TOCThemeOrder.toc'
        db.add_column(u'data_manager_tocthemeorder', 'toc',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TOCThemeOrder.toc'
        db.delete_column(u'data_manager_tocthemeorder', 'toc_id')
