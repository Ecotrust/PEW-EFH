...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.species'
        db.add_column(u'scenarios_scenario', 'species',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.species_input'
        db.add_column(u'scenarios_scenario', 'species_input',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenarios.Species'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.lifestage'
        db.add_column(u'scenarios_scenario', 'lifestage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.lifestage_input'
        db.add_column(u'scenarios_scenario', 'lifestage_input',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.species'
        db.delete_column(u'scenarios_scenario', 'species')

        # Deleting field 'Scenario.species_input'
        db.delete_column(u'scenarios_scenario', 'species_input_id')

        # Deleting field 'Scenario.lifestage'
        db.delete_column(u'scenarios_scenario', 'lifestage')

        # Deleting field 'Scenario.lifestage_input'
        db.delete_column(u'scenarios_scenario', 'lifestage_input')
