...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.hsall_m2_checkboxes'
        db.add_column(u'scenarios_scenario', 'hsall_m2_checkboxes',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.hsall_m2_checkboxes'
        db.delete_column(u'scenarios_scenario', 'hsall_m2_checkboxes')
