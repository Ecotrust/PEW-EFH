...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SpeciesHabitatOccurence.perferred_min_depth'
        db.delete_column(u'scenarios_specieshabitatoccurence', 'perferred_min_depth')

        # Deleting field 'SpeciesHabitatOccurence.perferred_max_depth'
        db.delete_column(u'scenarios_specieshabitatoccurence', 'perferred_max_depth')

        # Adding field 'SpeciesHabitatOccurence.preferred_min_depth'
        db.add_column(u'scenarios_specieshabitatoccurence', 'preferred_min_depth',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpeciesHabitatOccurence.preferred_max_depth'
        db.add_column(u'scenarios_specieshabitatoccurence', 'preferred_max_depth',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SpeciesHabitatOccurence.perferred_min_depth'
        db.add_column(u'scenarios_specieshabitatoccurence', 'perferred_min_depth',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpeciesHabitatOccurence.perferred_max_depth'
        db.add_column(u'scenarios_specieshabitatoccurence', 'perferred_max_depth',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SpeciesHabitatOccurence.preferred_min_depth'
        db.delete_column(u'scenarios_specieshabitatoccurence', 'preferred_min_depth')

        # Deleting field 'SpeciesHabitatOccurence.preferred_max_depth'
        db.delete_column(u'scenarios_specieshabitatoccurence', 'preferred_max_depth')
    ...
    models = {
        ...
        u'scenarios.scenario': {
            ...
            'species_input': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['scenarios.Species']", 'null': 'True', 'blank': 'True'}),
