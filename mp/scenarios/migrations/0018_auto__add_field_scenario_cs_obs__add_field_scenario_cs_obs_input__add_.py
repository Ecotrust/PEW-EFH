...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.cs_obs'
        db.add_column(u'scenarios_scenario', 'cs_obs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.cs_obs_input'
        db.add_column(u'scenarios_scenario', 'cs_obs_input',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.cs_spm'
        db.add_column(u'scenarios_scenario', 'cs_spm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.cs_spm_input'
        db.add_column(u'scenarios_scenario', 'cs_spm_input',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.cs3500_obs'
        db.add_column(u'scenarios_scenario', 'cs3500_obs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.cs3500_obs_input'
        db.add_column(u'scenarios_scenario', 'cs3500_obs_input',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.cs3500_spm'
        db.add_column(u'scenarios_scenario', 'cs3500_spm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.cs3500_spm_input'
        db.add_column(u'scenarios_scenario', 'cs3500_spm_input',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Scenario.hsanti4_m2'
        db.add_column(u'scenarios_scenario', 'hsanti4_m2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.hssclr4_m2'
        db.add_column(u'scenarios_scenario', 'hssclr4_m2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Scenario.cs_obs'
        db.delete_column(u'scenarios_scenario', 'cs_obs')

        # Deleting field 'Scenario.cs_obs_input'
        db.delete_column(u'scenarios_scenario', 'cs_obs_input')

        # Deleting field 'Scenario.cs_spm'
        db.delete_column(u'scenarios_scenario', 'cs_spm')

        # Deleting field 'Scenario.cs_spm_input'
        db.delete_column(u'scenarios_scenario', 'cs_spm_input')

        # Deleting field 'Scenario.cs3500_obs'
        db.delete_column(u'scenarios_scenario', 'cs3500_obs')

        # Deleting field 'Scenario.cs3500_obs_input'
        db.delete_column(u'scenarios_scenario', 'cs3500_obs_input')

        # Deleting field 'Scenario.cs3500_spm'
        db.delete_column(u'scenarios_scenario', 'cs3500_spm')

        # Deleting field 'Scenario.cs3500_spm_input'
        db.delete_column(u'scenarios_scenario', 'cs3500_spm_input')

        # Deleting field 'Scenario.hsanti4_m2'
        db.delete_column(u'scenarios_scenario', 'hsanti4_m2')

        # Deleting field 'Scenario.hssclr4_m2'
        db.delete_column(u'scenarios_scenario', 'hssclr4_m2')
