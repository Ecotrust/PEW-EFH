...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Scenario.species_input' to match new field type.
        db.rename_column(u'scenarios_scenario', 'species_input_id', 'species_input')
        # Changing field 'Scenario.species_input'
        db.alter_column(u'scenarios_scenario', 'species_input', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Removing index on 'Scenario', fields ['species_input']
        db.delete_index(u'scenarios_scenario', ['species_input_id'])


    def backwards(self, orm):
        # Adding index on 'Scenario', fields ['species_input']
        db.create_index(u'scenarios_scenario', ['species_input_id'])


        # Renaming column for 'Scenario.species_input' to match new field type.
        db.rename_column(u'scenarios_scenario', 'species_input', 'species_input_id')
        # Changing field 'Scenario.species_input'
        db.alter_column(u'scenarios_scenario', 'species_input_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scenarios.Species'], null=True))
