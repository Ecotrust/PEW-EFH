...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.hsall_m2'
        db.add_column(u'scenarios_scenario', 'hsall_m2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.hsall_m2_min'
        db.add_column(u'scenarios_scenario', 'hsall_m2_min',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.hsall_m2'
        db.delete_column(u'scenarios_scenario', 'hsall_m2')

        # Deleting field 'Scenario.hsall_m2_min'
        db.delete_column(u'scenarios_scenario', 'hsall_m2_min')
